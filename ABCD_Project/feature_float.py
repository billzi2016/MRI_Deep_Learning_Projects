...
CSV_PATH    = 'data.csv'
NII_DIR     = 'nii_data'
MODEL_PATH  = 'best_model_float.pt'
SAVE_FEAT   = 'features_float.csv'
...
def extract():
    ...
    # Recompute the same MinMax scaling used during training
    scaler           = MinMaxScaler()
    ...
    feat_df = feat_df.merge(
        df[['nii.gz_name', 'score', 'score_norm']], on='nii.gz_name', how='left'
    )
